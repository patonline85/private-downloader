...
<head>
    ...
    <style>
        ...
        .logo-img { max-width: 120px; margin-bottom: 15px; border-radius: 50%; }
        h2 { color: var(--accent-color); margin-bottom: 25px; font-weight: 600; text-transform: uppercase; }
        .input-group { position: relative; margin-bottom: 25px; text-align: left; }
        input[type="text"] { width: 100%; padding: 14px 90px 14px 15px; border: 2px solid #e0e0e0; border-radius: var(--border-radius); box-sizing: border-box; font-size: 16px; outline: none; background: #fafafa; }
        ...
        button#submitBtn:hover { background: #3e2723; }
        button#submitBtn:disabled { background: #bdbdbd; cursor: not-allowed; }
        ...
        .save-btn { display: inline-block; padding: 14px 35px; background: var(--success-color); color: white; text-decoration: none; border-radius: var(--border-radius); font-weight: bold; font-size: 16px; }
...
<body>
    <div class="container">
        ...
        <div id="downloadArea">
            <p style="color: var(--success-color); font-weight: bold;">✅ Đã xong!</p>
